    ...
    if (empty($_POST)) {
        ...
        echo <<<ooo
                <form action="" class="container" method="post">
                    ...
                    <input type="submit" value="Add Topic" class="box-s">
                </form>
            ooo;
    } else {
        ...
        if (empty($res)) {
            ...
            if ($password == $res['password']) {
                $query = "INSERT INTO TOPIC (name,email) VALUES ('$name','$email');";
                $ret = $db->exec($query);
                if (!$ret) {
                    ...
                    // echo "<img src='https://media.giphy.com/media/MXR1EW8ihlphu5eZfH/giphy.gif'/>";
                    echo "<h1 style='color:blue' >Topic added Successfully.</h1>";
                    unset($_POST);
                    $_POST = array();
                }
            } else {
